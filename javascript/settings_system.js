//VideoRay
if (document.images) {
  settingsSystem = new Image;
  settingsSystemBase = new Image;
  systemData = new Image;
  systemDepth = new Image;
  systemCompass = new Image;
  systemUnits = new Image;
  systemHelp = new Image;
  systemVideo = new Image;

  settingsSystem.src = '../images/usersettings_systemsettings_full_highlight_scaled.png';
